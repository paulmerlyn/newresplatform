...
$dbname = "paulme6_newresolution";
$sendto = "Webmaster <paul@newresolutionmediation.com>";
$sendfrom = "Automated Backup <donotreply@newresolutionmediation.com>";
$sendsubject = "Daily MySQL Backup for ".date("F d, Y")." (New Resolution Platform)";
...
/* To effect a non-zip backup, comment out the above four lines and uncomment the two lines below: */
$backupfile = $dbname . date("Y-m-d") . '.sql';
system("mysqldump -h $dbhost -u $dbuser -p$dbpass $dbname > $backupfile"); // Good documentation on the mysqldump command at http://articles.sitepoint.com/article/backing-up-mysqldump
...
$message->AddAttachment($backupfile); /* To effect a zip back-up, comment out this line and uncomment the line below and uncomment this line instead. */
...
unlink($backupfile); /* To effect a non-zip back-up, uncomment this line below and comment out the line below instead. */
//unlink($backupzip);
?>
