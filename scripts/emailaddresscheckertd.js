// JavaScript Document
<!-- Note: this file differs from emailaddresscheck.js only in the alert message that's displayed at the very. I need a different alert message for a 'test-driver' who has successfully entered a test-drive version of the schedule form (c_schedmediationformtd.php) (i.e. the emailaddresscheckertd1.js version) than the version that is used on the standard version on the live site (emailaddresschecker.js) and the version that is used on successful submission of emailtdform.php (i.e. emailaddresscheckertd.js). Finally, version /scripts/emailaddresschecker_noalert.js gets used in validation of the profile form inside updateprofile.php.  -->
...
// If we've gotten this far, everything's valid so far!  ...

alert('Your test drive has been configured.\n\nNow please fill out the form on the next screen as if you were a client who wants to schedule a mediation session. The form results will be automatically emailed to the name and email address that you just provided.\n\nPlease click \'OK\'.');
return true;
}
