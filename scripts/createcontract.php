<?php
/*
This script (somewhat inspired by Welling/Thomson Chapter 32) is called when the user clicks the 'Review/Sign Agreement' button in licenseonramp.php. Rather than use the template-based approach (in Welling/Thomson pp 800-801), which didn't quite work for me, it generates PDF content programmatically using the Free PDF (FPDF) library at fpdf.org. My code draws from Tutorial 6 on fpdf.org.
*/
...
// Create short names for the user-specific data that will be used to customize a generic version of the contract document.
$locale = $_POST['locale'];
$licfee = $_POST['licfee'];
$licterm = $_POST['licterm'];
$date = date('F jS, Y');
...
<title>Generate User's Bespoke Internet Marketing Agreement</title>
</head>
<body>
...
<!--  Having generated a PDF version of the contract customized for each particular licensee, now redirect to AlphaTrust's web site where the user can e-sign the Licensing Agreement. Alternatively, I could make an API call at this point in the code. -->
<script language="javascript" type="text/javascript">
<!--
window.location = 'https://pronto1.alphatrust.com/Public/ProcessTemplates/Launch/?p=e00ad887-7d49-47e3-82e2-a7821fdcb851'; // Formerly, I tested with url = https://test1.alphatrust.com/Public/ProcessTemplates/Launch/?p=adca8516-6ad1-4096-9375-90ff1ef7a467&mode=test
// -->
</script>
<noscript>
<?php
header('Location: https://pronto1.alphatrust.com/Public/ProcessTemplates/Launch/?p=e00ad887-7d49-47e3-82e2-a7821fdcb851'); /* Formerly, while testing, the location was https://test1.alphatrust.com/Public/ProcessTemplates/Launch/?p=adca8516-6ad1-4096-9375-90ff1ef7a467&mode=test */
die();
ob_flush();
?>
</noscript>
