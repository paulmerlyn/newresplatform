<?php
/* 
ipfaxcover.php is one of the files in the Intellectual Property Library. Components of the library are: iplogo.php, ipbusinesscard.php, ipletterhead.php, ipemailsig.php, ipwirescrossed.php, ippostcard.php, and ipfaxcover. These files are accessible via the Milonic tramline menu after a user has successfully logged in (i.e. gotten his/her $_SESSION['ValidUserFlag'] set to 'true') via the log-in screen in either updateprofile.php or iplibrary.php. */
ob_start();
session_start();
...
<!-- The ipfaxcover.php file is opened when a user clicks on the 'Fax Cover' menu item in Milonic tramline menu item (see /milonic_tramline/menu_data.js) inside iplibrary.php. -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<title>IP Library | Fax Cover</title>
...
<!--
 if (document.images) 
  {
 	 pic1 = new Image(508,653); pic1.src = "/images/JaneDoeFaxCover_screen_large.jpg"; // (width, height) of magnified image
  }
...
if (document.images) 
	{
      document["image2"].src = "/images/JaneDoeFaxCover_screen_large.jpg"; 
	}
}
...
if (document.images)
	{
	  document["image2"].src = "/images/JaneDoeFaxCover_screen.jpg"; 
	}
}
...
<h2 style="margin-left: 150px;">FAX COVER</h2>
<p class="text">Download the fax cover as a Microsoft Word document:</p>
...
<span style="font-size: 12px;">Bleed version:<br>
</span>
<div style="float: left;">
<form action="/scripts/filedownloader.php" method="get">
<input type="hidden" value="/home/paulme6/public_html/nrmedlic/downloadables/JaneDoeFaxCoverNew.doc" name="file" id="file">
...
<td rowspan="2" align="right" valign="top" width="460">
<div style="position: absolute; width: 420px;">
<a name="cardfront"></a>
<img name="image2" src="/images/JaneDoeFaxCover_screen.jpg" alt="New Resolution Mediation fax cover" style="position: absolute; top: -60px; right: 70px;">
...
<div style="margin-left: 0px; margin-top: 265px; font-size: 12px;">If using a professional-grade color printer/fax with capability to print to the paper&rsquo;s edge, download the bleed version. Otherwise, download the no-bleed version.<br><br>
...
<div style="margin-left: 20px;">
<span style="font-size: 12px;">No-bleed version:<br>
</span>
<div style="float: left;">
<form action="/scripts/filedownloader.php" method="get">
<input type="hidden" value="/home/paulme6/public_html/nrmedlic/downloadables/JaneDoeFaxCoverNoBleedNew.doc" name="file" id="file">
<input type="submit" name="download" style="margin-top: 8px; width: 120px;" value="Download" <?php if (isset($_SESSION['Guest'])) { echo 'disabled'; } else { echo 'class="buttonstyle"'; }; ?>>
</form>
</div>
</div>
